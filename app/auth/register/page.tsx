  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <h1 className="text-2xl font-semibold text-zinc-900 mb-1">Créer un compte</h1>
        <p className="text-sm text-zinc-500 mb-8">Commencez votre formation IA terrain.</p>
